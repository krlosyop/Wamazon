...
CREATE TABLE tbl03_producto (id_producto int(10) NOT NULL AUTO_INCREMENT, id_categoria int(10) NOT NULL, nb_producto varchar(80) NOT NULL, nu_precio float NOT NULL, nu_existencia int(10) NOT NULL, dx_descripcion varchar(255) NOT NULL, bl_fotografia blob, PRIMARY KEY (id_producto, id_categoria));
...
CREATE TABLE tbl05_compra (id_compra int(10) NOT NULL AUTO_INCREMENT, id_usuario int(10) NOT NULL, fh_compra datetime null, PRIMARY KEY (id_compra));
...
CREATE TABLE tbl07_usuario (id_usuario int(10) NOT NULL AUTO_INCREMENT, tx_login varchar(15) NOT NULL, tx_password varchar(15) NOT NULL, nb_usuario varchar(20) NOT NULL, tx_apa varchar(20) NOT NULL, tx_apb varchar(20) NOT NULL, rol int(10), PRIMARY KEY (id_usuario));
...
ALTER TABLE tbl03_producto ADD CONSTRAINT FKtbl03_prod205652 FOREIGN KEY (id_categoria) REFERENCES tbl01_categoria (id_categoria);
...
ALTER TABLE tbl06_producto_compra ADD INDEX FKtbl06_prod758312 (id_producto, id_categoria), ADD CONSTRAINT FKtbl06_prod758312 FOREIGN KEY (id_producto, id_categoria) REFERENCES tbl03_producto (id_producto, id_categoria);
